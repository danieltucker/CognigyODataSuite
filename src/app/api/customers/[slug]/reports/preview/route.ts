...
export async function GET(
  ...
  // the ALLOWED whitelist — never from raw user input. If ALLOWED is extended, keep
  // all keys and column names to [a-z0-9_] to avoid SQL injection via interpolation.
